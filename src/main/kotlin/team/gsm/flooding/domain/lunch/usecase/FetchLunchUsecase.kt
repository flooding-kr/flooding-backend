...
class FetchLunchUsecase (
	...
	fun execute(date: LocalDate, lunchTime: LunchTime): FetchLunchResponse {
		...
		val menu = row[0].ddishNm.split("<br/>").map {
	...
	fun getLunchResponse(date: LocalDate, lunchTime: LunchTime): FetchLunchClientResponse? {
