    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        ...
        return http
            .authorizeHttpRequests {
                it // Neis
                    .requestMatchers("/neis/**")
                    .hasAuthority(ROLE_USER)

                it // User
                    .requestMatchers(HttpMethod.GET, "/user/student/search")
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.GET, "/user/teacher/search")
                    .hasAuthority(ROLE_USER)
                    ...
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.GET, "/admin/user/pending")
                    .hasAuthority(ROLE_USER_ADMIN)
                    .requestMatchers(HttpMethod.PATCH, "/admin/user/{userId}/approve")
                    .hasAuthority(ROLE_USER_ADMIN)
                ...
                it // Self Study
                    .requestMatchers(HttpMethod.POST, "/self-study")
                    .hasAuthority(ROLE_STUDENT)
                    .requestMatchers(HttpMethod.DELETE, "/self-study")
                    .hasAuthority(ROLE_STUDENT)
                ...
                it // Attendance
                    ...
                    .hasAuthority(ROLE_STUDENT)
                    .requestMatchers(HttpMethod.GET, "/attendance/myself")
                    .hasAnyAuthority(ROLE_STUDENT)
                    .requestMatchers(HttpMethod.GET, "/attendance/club/{clubId}")
                ...
                it // Music
                    ...
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.DELETE, "/music")
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.PATCH, "/music/{musicId}/like")
                    .hasAuthority(ROLE_USER)

                it // Massage
                    .requestMatchers(HttpMethod.POST, "/massage")
                    .hasAuthority(ROLE_STUDENT)
                    .requestMatchers(HttpMethod.DELETE, "/massage")
                    .hasAuthority(ROLE_STUDENT)
                    .requestMatchers(HttpMethod.GET, "/massage/count")
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.GET, "/massage/rank")
                    .hasAuthority(ROLE_USER)
                    .requestMatchers(HttpMethod.PATCH, "/admin/massage/limit")
                    .hasAuthority(ROLE_DORMITORY_ADMIN)
