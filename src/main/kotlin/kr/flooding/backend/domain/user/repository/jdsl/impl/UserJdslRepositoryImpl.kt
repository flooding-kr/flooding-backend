package kr.flooding.backend.domain.user.repository.jdsl.impl
...
class UserJdslRepositoryImpl(
	...
	override fun findByNameContainsAndYearGreaterThanEqualAndRolesContains(
		name: String,
		year: Int,
		role: RoleType,
	): List<User> {
	...
	override fun findByNameContainsAndRolesContains(
		name: String,
		role: RoleType,
	): List<User> {
		val query =
